...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "68-longjmp_16-counting-local-one-method_true.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
