...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "68-longjmp_18-simple-else_unknown_1_neg.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
